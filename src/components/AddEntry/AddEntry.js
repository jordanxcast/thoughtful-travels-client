...
class AddEntry extends Component {
  ...
  handleSubmit(e) {
    ...
    const error =
      this.validateEntrySubject(entrySubject) &&
      this.validateEntryBody(entryBody);
  ...
  render() {
    ...
    return (
      <div className="AddEntry">
        <form className="AddEntry-form" onSubmit={(e) => this.handleSubmit(e)}>
          ...
          <div className="add-entry-button-group">
            <button
              ...
              onClick={() =>
                this.props.history.push(`/destinations/${dest_id}`)
              }
            >
              Cancel
            </button>
