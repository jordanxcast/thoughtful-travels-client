    ...
    return (
      <main>
        <header className="LP-header">
          ...
          <h2>Your Journey, Your Experience</h2>
        </header>
        <div className="LP-sections">
          ...
          <section className="LP-section">
            ...
            <p>
              ...
              experience through traveling is invaluable. Reflect on the travel
              goals you complete with a journal entry, documenting the moments
          ...
          <section className="LP-signUp">
            ...
            {/* <button className="LP-link-button">
              {" "} */}
